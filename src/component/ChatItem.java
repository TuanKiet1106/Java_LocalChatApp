...
public class ChatItem extends javax.swing.JPanel {
    ...
    public void setTimeRight(String time) {
        JLayeredPane layer = new JLayeredPane();
        layer.setLayout(new FlowLayout(FlowLayout.RIGHT, 0, 0));
        layer.setBorder(new EmptyBorder(0, 5, 10, 5));
        label = new JLabel(time);
    ...
    public void setFileRight(String fileName, String fileSize) {
        JLayeredPane layer = new JLayeredPane();
        layer.setLayout(new FlowLayout(FlowLayout.LEFT));
        layer.setBorder(new EmptyBorder(0, 5, 0, 5));
        ChatFile chatFile = new ChatFile();
        chatFile.setFileRight(fileName, fileSize);
        layer.add(chatFile);
        add(layer);
    }
    ...
    private void initComponents() {
        ...
        txt.setSelectionColor(new java.awt.Color(0, 0, 0));
        add(txt);
